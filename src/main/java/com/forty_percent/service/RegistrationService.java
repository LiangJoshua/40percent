...
import com.forty_percent.util.email.EmailSender;
...
public class RegistrationService{
	...
	@Transactional
	public void register(RegistrationRequest registrationRequest) throws UserRegistrationException{
		try {
			...
			String token = confirmationTokenService.saveConfirmationToken(applicationUser);
	...
	@Transactional
	public void confirmToken(String token) throws UserRegistrationException{
		ConfirmationToken confirmationToken = confirmationTokenService.confirmToken(token);
		applicationUserService.enableUser(confirmationToken.getApplicationUser());
	}
